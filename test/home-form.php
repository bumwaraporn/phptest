...
<body>
	...
	<table align="center">
		<tr>
			<th>
				<form action="member-form.php" method="post">
					<input type="submit" value="รายชื่อสมาชิก">
				</form>
			</th>
			<th>
				<form action="homeme-form.php" method="post">
					<input type="submit" value="ตะกร้าของฉัน">
				</form>
			</th>
			<th>
				<form action="addproduct-form.php" method="post" target="_blank">
	...
	<table align="center" id="myTable">
		...
		?>
  		<tr>
			...
			<td>
				<form action="editproduct-form.php" method="post" target="_blank">
					<button type="submit" name="id" value="<?php echo $row["id"]; ?>">แก้ไขสินค้า</button>
				</form>
			</td>
			<td>
				<form action="delproduct.php" method="post" target="_blank">
    ...
    <br><br>
    <!-- ออกจากระบบ -->
	<form action="logout.php" method="post"><input type="submit" value="ออกจากระบบ"></form>
</body>
</html>
<?php $conn->close(); } ?>